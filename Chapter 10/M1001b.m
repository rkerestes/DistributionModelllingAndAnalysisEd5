...
%Caucluating regulator voltages in neutral position
Vreg = VLN3/Npt;
vprint(Vreg,'Vreg')

%Calculating the compensator currents
Icomp = Iabc/CT;
iprint(Icomp,'Icomp')

%Calculating the relay voltages 
